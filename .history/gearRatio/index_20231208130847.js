...
const isValidRange = (symbols,n) => symbols.some(s => {
    const validRanges = [n.i - 1, n.i,n.i+n.v.length, n.i + n.v.length + 1];
...
const sum = ()=>{
    ...
    lines.forEach((line, i) => {
       const numbers = getNumbers(line);
        ...
        console.log(numbers, prevSymb, currentSymb, nextSymb, numbers.filter(n=>isValidRange(prevSymb, n) || isValidRange(currentSymb, n) || isValidRange(nextSymb, n)).map(v=>parseInt(v.v)))
