...
const isValidSIngleRage = (s, n, line) => {
...
const isValidRange = (symbols,n,line) => symbols.some(s=>isValidSingleRange(s,n,line))
...
const sum2 = () => {
    ...
    lines.forEach((line, i) => {
        ...
        console.log(gears,prevNumbers.filter(n=>isValidSIngleRage(n.ix,gears[0],line)),
            currentNumbers.filter(n => isValidSIngleRage(n.ix, gears[0], line)) ,
            nextNumbers.filter(n => isValidSIngleRage(n.ix, gears[0], line)))
    })
}
sum2()
